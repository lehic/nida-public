...
const AR: Copy = {
  ...
  pillars: {
    ...
    items: [
      ...
      { n: '٠٢', t: 'هادئ',  d: 'لا فوضى. لا حِيَل تصميميّة خادعة. لا سلاسل يوميّة مصنوعة لتوليد القلق. الواجهة تخدم الخشوع — إذا لم يُعِنْك البكسل على الصلاة، فلا مكان له.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'لِمَ لا نستخدم تطبيقًا موجودًا؟', a: 'لأنّ التطبيقات المهيمنة تحوّلت إلى تطبيقات ضخمة مثقلة بالإعلانات، تخدم المعلنين أولًا. أحدها باع بيانات الموقع لمئة مليون مسلم. وظيفة تطبيق الصلاة واحدة: أن يُعينك على الصلاة في وقتها.' },
